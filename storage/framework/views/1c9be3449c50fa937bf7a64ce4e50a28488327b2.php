<nav class="navbar bg-gradient-primary" id="navbar-main">
    <div class="container-fluid">
        <!-- Brand -->
        <a class="" href="<?php echo e(url('/')); ?>">Teste Back End</a>
        <!-- User -->
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <img class='rounded-pill' src='<?php echo e(url("/img/destaque-albert-einstein.jpg")); ?>' width='40' height='40' alt='Albert Einsten'>
                </a>
...
<?php /**PATH C:\wamp\www\perfect-test-backend-master\resources\views/layout_header.blade.php ENDPATH**/ ?>